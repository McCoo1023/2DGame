...
public class GamePanel extends JPanel implements Runnable {
	...
	public ForgottenArtifactQuest forgottenArtifactQuest; // my first quest
	...
	public void setupGame() {
	    ...
	    forgottenArtifactQuest = new ForgottenArtifactQuest("Forgotten Artifact", "Description", 50);
	...
	public void drawQuestJournal(Graphics2D g2) {
	    // Set the color and font for the journal
	    ...
	    g2.drawString("Quest Journal", 350, 130);

	    // Loop through quests in the journal and draw them
	    int y = 160;
	    for (Quest quest : player.getQuestJournal().getActiveQuests()) {
	        g2.drawString(quest.getQuestName(), 120, y);
	        g2.drawString(quest.getDescription(), 120, y + 20);
	        y += 50;
	    }
	}
	...
	public void paintComponent(Graphics g) {
	 ...
	 // Check if quest journal should be displayed
	    if (keyH.showQuestJournal) {
	        drawQuestJournal(g2);
	    }
