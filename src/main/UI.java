...
//		g2.setFont(maruMonica);
	...
	public void drawQuestJournal(Graphics2D g2) {
	    ArrayList<Quest> activeQuests = gp.player.getQuestJournal().getActiveQuests();
	    ArrayList<Quest> completedQuests = gp.player.getQuestJournal().getCompletedQuests();
	    
	    // Draw UI box or whatever you want to display the journal
	    
	    // Display active quests
	    for (Quest quest : activeQuests) {
	        // Draw each quest name and objectives
	    }

	    // Display completed quests
	    for (Quest quest : completedQuests) {
	        // Draw each quest name as completed
	    }
	}
